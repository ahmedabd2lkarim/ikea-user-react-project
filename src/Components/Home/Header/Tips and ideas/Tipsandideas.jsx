...
const categories = [
  ...
  {
    id: 7,
    title: "Everyday actions matter. See some ideas",
    // image:
  ...
  return (
    ...
    >
      ...
      <Stack width={{ xs: "90%", sm: "53%" }} mt={10} mb={8} marginLeft={4}>
        ...
        >
          Welcome to IKEA Egypt! Find the <Link href="https://www.ikea.com/eg/en/offers/#">best deals</Link> on{" "}
          <Link href="https://www.ikea.com/eg/en/cat/furniture-fu001/">furniture products</Link>,{" "}
          <Link href="https://www.ikea.com/eg/en/cat/lighting-li001/">lighting</Link> and{" "}
          <Link href="https://www.ikea.com/eg/en/cat/decoration-de001/">home decoration</Link>! Choose from our range of cosy{" "}
          <Link href="https://www.ikea.com/eg/en/rooms/living-room/">living room furniture</Link> and comfortable{" "}
          <Link href="https://www.ikea.com/eg/en/rooms/dining/">dining room furniture</Link>. Start browsing now and
