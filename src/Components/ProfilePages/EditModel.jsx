      ...
      >
        <div className="modal-content">
          ...
          >
                ...
                render={({ field }) => (
                  <Select
                    ...
                    style={{
                      ...
                      borderColor:
                        touchedFields.gender || dirtyFields.gender
                          ? errors.gender
                            ? "red"
                            : "green"
                          : "inherit",
                  ...
                  >
                    ...
                    <MenuItem value="">
                      {t("Edit_User.Prefer_not_say")}
                    </MenuItem>
                    <MenuItem value="male">{t("Edit_User.Male")}</MenuItem>
                    <MenuItem value="female">{t("Edit_User.Female")}</MenuItem>
                    <MenuItem value="other">{t("Edit_User.Other")}</MenuItem>
                  </Select>
                )}
              />
            </FormControl>
            ...
            <div
              style={{
                borderTop: ".5px solid rgb(212, 211, 211)",
                paddingTop: "10px",
              }}
            >
              <Grid className="login-form-page" marginTop={2} container>
                <Grid size={{ xs: 12, md: 1 }}>
                  <InfoOutlineIcon
                    style={{ fontSize: "18px", color: "rgb(2, 107, 173)" }}
                  />
                </Grid>
